...
const dict: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "reg.title": "Inscription au HACKATON GITEGA",
    ...
    "dash.subtitle": "Gestion des inscriptions au HACKATON GITEGA",
    ...
    "login.subtitle": "Accès réservé aux organisateurs du HACKATON GITEGA.",
    "login.email": "Email",
  ...
  en: {
    ...
    "hero.title1": "Bitcoin",
    "hero.title2": "Bootcamp",
    "hero.subtitle": "30 young Burundians, five days, a fully hands-on approach. Three days of training — including a hybrid session on software security — then the hackathon.",
    "hero.apply": "Apply now",
    "hero.discover": "Explore the program",
    "stat.participants": "Participants",
    "stat.hackathons": "Days",
    "stat.workshops": "Training days",
    "stat.prize": "Winning teams",
    "program.kicker": "// Program",
    "program.title": "From theory to practice",
    "program.subtitle": "Three days of training, including a hybrid session on software security, then the hackathon.",
    "prog.1.t": "Bitcoin fundamentals",
    "prog.1.d": "Permissionless P2P exchanges — no intermediaries, no KYC.",
    "prog.2.t": "Software security",
    "prog.2.d": "Hybrid session on software security and decentralized systems.",
    "prog.3.t": "Node & Lightning",
    "prog.3.d": "Spin up a Bitcoin Core node and Lightning SDKs live.",
    "prog.4.t": "Hackathon & pitches",
    "prog.4.d": "Group work, mentorship, final demos in front of a jury.",
    "sched.kicker": "// Schedule",
    "sched.title": "Five days in Gitega",
    "sched.month": "SEPT 2026",
    "sched.h1.t": "Training — 3 days",
    "sched.h1.s": "Bitcoin, development and software security (hybrid session)",
    "sched.h2.t": "Hackathon & pitches",
    "sched.h2.s": "Group work, then pitching to the jury",
    "sched.prizes": "🏆 The top two teams win prizes",
    ...
    "reg.title": "HACKATON GITEGA registration",
    ...
    "dash.title": "Dashboard",
    "dash.subtitle": "Managing HACKATON GITEGA registrations",
    ...
    "login.kicker": "// Admin",
    "login.title": "Sign in",
    "login.subtitle": "Reserved for HACKATON GITEGA organizers.",
    "login.email": "Email",
