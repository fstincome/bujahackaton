...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Deux hackathons Bitcoin P2P à Bujumbura. Workshops, Lightning Network, Vexl. 5-6 juin 2026." },
      { name: "twitter:description", content: "Deux hackathons Bitcoin P2P à Bujumbura. Workshops, Lightning Network, Vexl. 5-6 juin 2026." },
